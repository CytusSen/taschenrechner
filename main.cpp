...
class MainWindow : public QWidget       //Klasse MainWindow kriegt QWidget von Public vererbt
{
	...
	void button7_clicked();											             void button8_clicked();
        void button9_clicked();												     void buttonAddieren_clicked();										          void buttonSubtrahieren_clicked();
	void buttonMultiplizieren_clicked();										     void buttonDividieren_clicked();
	void buttonErgebnis_clicked();
	void buttonLoschen_clicked();											     double zahl1;
	double zahl2;
	double ergebnis;												     char operation;
	public:
															    MainWindow();
};
...
MainWindow::MainWindow()
{
		...
		QPushButton *buttonMultiplizieren = new QPushButton();                                                               buttonMultiplizieren->setText("*");
		...
		grid->addWidget(buttonLoschen, 5, 2);
